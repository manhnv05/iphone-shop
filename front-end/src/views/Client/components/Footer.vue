    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div class="md:col-span-2">
          <h3 class="text-2xl font-bold mb-4 text-blue-400">TopZone</h3>
          <p class="text-gray-400 mb-4">
            Hệ thống bán lẻ iPhone, iPad, Mac, Apple Watch chính hãng uy tín hàng đầu Việt Nam
          </p>
        ...
        <!-- Thông tin -->
        <div>
          <h4 class="font-semibold mb-4 text-lg">Thông tin</h4>
          <ul class="space-y-2 text-gray-400">
            ...
            <li><a href="#" class="hover:text-white transition-colors">Hệ thống cửa hàng</a></li>
        ...
        <!-- Chính sách -->
        <div>
          <h4 class="font-semibold mb-4 text-lg">Chính sách</h4>
          <ul class="space-y-2 text-gray-400">
        ...
        <!-- Liên hệ -->
        <div>
          <h4 class="font-semibold mb-4 text-lg">Liên hệ</h4>
          <ul class="space-y-3 text-gray-400">
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span>Hotline: <strong class="text-white">1900 xxxx</strong></span>
            </li>
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span>support@topzone.vn</span>
            </li>
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="mt-8 pt-8 border-t border-gray-700">
        <h4 class="font-semibold mb-4 text-center">Phương thức thanh toán</h4>
        <div class="flex justify-center items-center space-x-4 flex-wrap">
          ...
          <img src="/images/payment/vnpay.png" alt="VNPay" class="h-8" />
          <img src="/images/payment/momo.png" alt="Momo" class="h-8" />
          <img src="/images/payment/zalopay.png" alt="ZaloPay" class="h-8" />
        </div>
      </div>

      <!-- Copyright -->
      <div class="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
        <p>&copy; 2025 TopZone. All rights reserved.</p>
        <p class="mt-2 text-sm">
          Công ty TNHH TopZone Việt Nam - GPĐKKD: 0123456789
        </p>
      </div>
    </div>
  </footer>

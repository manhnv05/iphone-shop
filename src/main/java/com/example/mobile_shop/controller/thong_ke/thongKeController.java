package com.example.mobile_shop.controller.thong_ke;

import com.example.mobile_shop.dto.thongKe.HangBanChayDTO;
import com.example.mobile_shop.dto.thongKe.LoaiHoaDonDTO;
import com.example.mobile_shop.dto.thongKe.SanPhamHetHangDTO;
import com.example.mobile_shop.dto.thongKe.SoLieuDTO;
import com.example.mobile_shop.dto.thongKe.TopSellingProductDTO;
import com.example.mobile_shop.service.thong_ke.ThongKeService;
import com.example.mobile_shop.service.thong_ke.ThongKeService;
...
public class thongKeController {
    ...
    public ResponseEntity<Resource> exportExcel(
            ...
            @RequestParam(required = false) String startDate, // Thêm cho custom
            @RequestParam(required = false) String endDate   // Thêm cho custom
    ) {
        Map<String, Object> ngay = sr.getThongKeTheoNgay();
        Map<String, Object> tuan = sr.getThongKeTheoTuan();
        Map<String, Object> thang = sr.getThongKeTheoThang();

package com.example.mobile_shop.repository.dot_giam_gia_repo;
...
import com.example.mobile_shop.entity.DotGiamGia;
...
public interface dot_giam_gia_repository extends JpaRepository<DotGiamGia, Integer> {
    ...
    @Query("SELECT new com.example.mobile_shop.dto.dot_giam_gia.viewSanPhamDTO(sp, nsx, hdh, " +
...
//                                 Pageable pageable);
    ...
    @Query("SELECT new com.example.mobile_shop.dto.dot_giam_gia.viewCTSPDTO(sp, ctsp, anh, bnt, ms, " +
